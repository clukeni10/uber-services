import {
    Box, Flex, HStack, VStack, Text, Heading, Separator,
    Button, Spinner, Dialog, Portal, Field, Input, Badge,
} from "@chakra-ui/react";
import {
    Select, createListCollection,
} from "@chakra-ui/react";
import {
    LuMapPin, LuStar, LuBriefcase, LuClock, LuCreditCard, LuArrowLeft,
} from "react-icons/lu";
...
export default function WorkerDetail() {
    ...
    async function onSubmit() {
        ...
        if (result) navigate("/client/services");
    }
                    ...
                    <Box  bg={white} borderRadius="2xl" border="1px solid" borderColor="gray.100" shadow="sm" overflow="hidden">
                        ...
                        <Box px="6" pb="6">
                            <HStack justify="space-between" align="flex-end" mt="-30px" mb="4">
                                ...
                                {worker?.image ? (
                                    <Box w="64px" h="64px" rounded="full" overflow="hidden"
                                        border="4px solid" borderColor={white} shadow="md"  position="relative" >
                                        <img src={worker.image} alt={worker.name}
                                            style={{ width: "100%", height: "100%", objectFit: "cover" }} />
                                    </Box>
                                ) : (
                                    <Flex bg={blue} w="64px" h="64px" rounded="full"
                                        ...
                                        <Dialog.Body py="4" px="2">
                                            <VStack gap="4">
                                                ...
                                                <Field.Root required>
                                                    ...
                                                    <Select.Root
                                                        collection={methods} size="sm"
                                                        value={[form.method]}
                                                        onValueChange={(e) => setForm({ ...form, method: e.value[0] as "card" | "transfer" })}
                                                    >
                                                        <Select.HiddenSelect />
                                                        <Select.Control>
